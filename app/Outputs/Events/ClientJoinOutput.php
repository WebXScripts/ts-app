...
readonly class ClientJoinOutput implements EventOutput
{
    public function __construct(
        ...
        public Collection $client_server_groups,
        ...
        public array|string|null $client_integrations = null,
        public array|string|null $client_myteamspeak_avatar = null,
        public array|string|null $client_signed_badges = null,
    )
    {
    }
    ...
    public static function fromCollection(Collection $collection): self
    {
        return new self(
            ...
            client_server_groups: collect(explode(',', (string)$collection->get('client_servergroups')))->map(static function (string $group) {
                return (int)$group;
            }),
